<template>
    <section id="home"
        ...
        <div
            ...
            <div class="md:text-[1.5em] text-[1em] my-[0.2em]">
                Combining experience, dedication, and ethical <br>
                values to serve our clients with distinction.
            </div>
        </div>
        <div
            class="bg-[#C7C4B7]/40 backdrop-blur-xl absolute right-0 top-[55%] lg:top-[25%] md:px-[1em] px-[0.5em] md:py-[1em] py-[0.5em] rounded-l-[2em] lg:rounded-l-[3em] lg:w-fit">
